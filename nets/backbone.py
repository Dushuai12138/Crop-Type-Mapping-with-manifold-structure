...
class MixVisionTransformer(nn.Module):
    def __init__(self, in_chans=16, num_classes=1000, embed_dims=[32, 64, 160, 256],
...
class mit_b0(MixVisionTransformer):
    def __init__(self, in_chans, pretrained = False):
        super(mit_b0, self).__init__(in_chans=in_chans,
...
class mit_b1(MixVisionTransformer):
    def __init__(self, in_chans, pretrained = False):
        super(mit_b1, self).__init__(in_chans=in_chans,
...
class mit_b2(MixVisionTransformer):
    def __init__(self, in_chans, pretrained = False):
        super(mit_b2, self).__init__(in_chans=in_chans,
            embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[4, 4, 4, 4],
...
class mit_b3(MixVisionTransformer):
    def __init__(self, in_chans, pretrained = False):
        super(mit_b3, self).__init__(in_chans=in_chans,
            embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[4, 4, 4, 4],
...
class mit_b4(MixVisionTransformer):
    def __init__(self, in_chans, pretrained = False):
        super(mit_b4, self).__init__(in_chans=in_chans,
            embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[4, 4, 4, 4],
...
class mit_b5(MixVisionTransformer):
    def __init__(self, in_chans, pretrained = False):
        super(mit_b5, self).__init__(in_chans=in_chans,
            embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[4, 4, 4, 4],
